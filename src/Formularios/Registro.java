...
public class Registro extends JFrame {
    ...
    String usuario = "", nombre = "", apellido = "", correo = "", telefono = "";
    String clave = "", confirmaClave = "";
    ...
    public Registro() {
        ...
        MFObj.agregarImagen(jButton_Registrar, "/Imagenes/registrarBtn.png");
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, -1, -1));
        ...
        jTextField_Nombre.setForeground(new java.awt.Color(204, 204, 255));
        ...
        jTextField_Apellido.setForeground(new java.awt.Color(204, 204, 255));
        ...
        jTextField_Correo.setForeground(new java.awt.Color(204, 204, 255));
        ...
        jTextField_Telefono.setForeground(new java.awt.Color(204, 204, 255));
        ...
        jPasswordField_ConfirmaClave.setForeground(new java.awt.Color(204, 204, 255));
        ...
        jPasswordField_Clave.setForeground(new java.awt.Color(204, 204, 255));
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        ...
        if (!usuario.equals("") && !nombre.equals("") &&
            ...
            //Verificación de que el nombre de usuario exista
            if (MUObj.obtenerUsuario(usuario) != null) {
                AdvModal.setTitulo(
            ...
            //Registro del usuario nuevo usuario
            else {
                ...
                //Se registra el usuario nuevo en la BD
                MUObj.registrarUsuario(nuevoUsuario);
                
                //Se le hace saber al usuario que se registró el usuario 
                msjModal.setTitulo("Usuario registrado con exito.");
        ...
        //En caso de que falten todos los campos
            ...
            AdvModal.setTitulo("Debes llenar todos los campos para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo usuario
        else if (usuario.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de usuario para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo nombre
        else if (nombre.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de nombre para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo apellido
        else if (apellido.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de apellido para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo telefono
        else if (telefono.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de telefono para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo correo
        else if (correo.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de correo para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo contraseña
        else if (clave.equals("")) {
            AdvModal.setTitulo("Debes llenar el campo de contraseña para registrarte.");
            AdvModal.mostrarDialog();
        }
        //En caso de que falte el campo confirmar contraseña
        else {
            AdvModal.setTitulo("Debes confirmar la contraseña para registrarte.");
            AdvModal.mostrarDialog();
        }
